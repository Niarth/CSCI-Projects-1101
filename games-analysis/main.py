...
plt.scatter(df_main["first)release_date"], df_main["user_rating_value"], color = "red", label = "User Ratings") 
...
df_main = pd.read_csv("game-rating-by-top-10-genres.csv")
...
plt.bar(df_hype.index + BAR_WIDTH / 2, df_hype["total_hypes"], color = "red", label = "Numbers of Hypes", width = BAR_WIDTH
...
df_main = pd.read_csv("game-rating-by-top-10-platforms.csv")
